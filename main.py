...
class save:
    ...
    def tor(self):
        ...
        if ch == 1:
            ...
            self.price = self.price + (800 * self.no_of_days)
            m[0] = 2
        elif ch == 3:
            self.price = self.price + (1360 * self.no_of_days)
            m[0] = 3
        elif ch == 4:
            self.price = self.price + (1650 * self.no_of_days)
            m[0] = 4
        else:
    ...
    def bill(self):
        ...
        print("\n")
        print("YOUR BILL AMOUNT Rs.", self.price)
        print("\n")
        if m[0] == 1:
            a = Delux
        elif m[0] == 2:
