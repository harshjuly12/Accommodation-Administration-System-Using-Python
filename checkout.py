    ...
    def __init__(self):
        def check_room():
            ...
            if self.rom.isdigit() == True and len(self.rom) != 0:
                self.Text1.insert(INSERT, " Enter valid room number ""\n")
                v = int(self.rom)
                f = open("hotel.dat", "rb")
                f1 = open("hote.dat", "ab")
                n = 0
        ...
        self.Entry1.configure(highlightbackground="#FFEBCD")
        ...
        self.Button1.configure(text='''LEAVE''')
